...
class MSmysqliDb
{
     ...
     *
     * @return MSmysqliDb Returns the current instance.
     */
	 ...
	 *                       
	 * @throws Exception
	 * @return MSmysqliDb if succeeeded;
	 */
    ...
    public function _buildDataPairs($tableData, $tableColumns, $isInsert)
    {
        foreach ($tableColumns as $column) {
            ...
            // Subquery value
            if ($value instanceof MSmysqliDb) {
     ...
     *
     * @return MSmysqliDb new mysqlidb object
     */
